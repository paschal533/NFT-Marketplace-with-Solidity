...
contract NFTMarket is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        function fetchItemsCreated() public view returns (MarketItem[] memory){
            ...
            for(uint i = 0; i < totalItemCount; i++){
                //get only the items that this user has created the owner
        ...
        /// @notice fetch amount of money made my a user
        function fetchAmount() public view returns (uint){
            ...
            for(uint i = 0; i < totalItemCount; i++){
                if(idMarketItem[i+1].seller = msg.sender && idMarketItem[i+1].sold == true){
                    uint currentId = idMarketItem[i+1].itemId;
                    uint soldItemPrice = idMarketItem[currentId].price;
                    amount += soldItemPrice;
                }
            }
            return amount;
        }
